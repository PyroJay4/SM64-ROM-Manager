...
Namespace My.Resources
    ...
    Friend Class ApplyPPFTranslation
        ...
        '''<summary>
        '''  Sucht eine lokalisierte Zeichenfolge, die Some files are missing! Redownload the programm to solve this problem. ähnelt.
        '''</summary>
        ...
        '''<summary>
        '''  Sucht eine lokalisierte Zeichenfolge, die Patch has been successfully applied! ähnelt.
        '''</summary>
        ...
        '''<summary>
        '''  Sucht eine lokalisierte Zeichenfolge, die An unknown error happend. Patch hasn&apos;t been applied. ähnelt.
        '''</summary>
