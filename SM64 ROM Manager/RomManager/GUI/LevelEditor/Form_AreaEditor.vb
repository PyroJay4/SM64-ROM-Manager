...
#Region "Declerations"
        ...
        Friend hashVisualMap As Integer = 0
...
#Region "Properties"
        ...
        Private Property FaceDrawMode As RenderMode
            Get
                ...
                If ButtonItem_DrawOutline.Checked Then val = val Or RenderMode.Outline
                If ButtonItem_DrawFill.Checked Then val = val Or RenderMode.Fill
                Return val
            End Get
            Set(value As RenderMode)
                ButtonItem_DrawOutline.Checked = (value And RenderMode.Outline) = RenderMode.Outline
                ButtonItem_DrawFill.Checked = (value And RenderMode.Fill) = RenderMode.Fill
            End Set
        End Property
...
#Region "Form & Controls"
        ...
        Private Sub SortObjectCombosAlphabetlicly()
        ...
        Private Sub CheckAndLoadNew()
            glControl1.MakeCurrent()
            Dim loadAreaIDs As Boolean = False

            If cArea Is Nothing Then
                loadAreaIDs = True
            End If

            If cLevel.Areas.Count <> ComboBoxItem_Area.Items.Count Then
                loadAreaIDs = True
            Else
                For Each ci As ComboItem In ComboBoxItem_Area.Items
                    If Not cLevel.Areas.Contains(ci.Tag) Then
                        loadAreaIDs = True
                    End If
                Next
            End If
            ...
            Else
                ...
                If hashCollisionMap <> cArea.AreaModel.Collision.GetHashCode Then
                    hashCollisionMap = 0
                    ...
                    End If
                End If
                If hashVisualMap <> cArea.AreaModel.Fast3DBuffer.GetBuffer.GetHashCode Then
                    hashVisualMap = 0
                    cVisualMap = Nothing
...
#Region "OpenGL"
        ...
        Private Sub glControl1_Paint(sender As Object, e As PaintEventArgs) Handles glControl1.Paint
            ...
            GL.ClearColor(If(Settings.StyleManager.AlwaysKeepBlueColors, Color.CornflowerBlue, BackColor))
...
#Region "Camera & Movements"
        ...
        Private Sub moveObjectXZ(obj As Managed3DObject, e As Drawing.Point, savedPos As Numerics.Vector3, forRotation As Boolean)
            ...
            Else
                speedMult = 0.5F
                Dim oldRot As Numerics.Vector3 = obj.Rotation
                Dim newRot As New Numerics.Vector3(Math.Truncate(savedPos.X - CShort(Math.Truncate(CX * my * speedMult * ObjectMoveSpeed)) - CShort(Math.Truncate(CX_2 * mx * speedMult * ObjectMoveSpeed))),
                                               oldRot.Y,
                                               Math.Truncate(savedPos.Z - CShort(Math.Truncate(CZ * my * speedMult * ObjectMoveSpeed)) - CShort(Math.Truncate(CZ_2 * mx * speedMult * ObjectMoveSpeed))))
        ...
        Private Sub AdvPropertyGrid1_RefreshPropertyValues()
            Try
        ...
        Private Sub ButtonItem22_Click(sender As Object, e As EventArgs) Handles ButtonItem1.Click
            If CurrentModelDrawMod = ModelDrawMod.VisualMap Then
                ...
                If rndrVisualMap IsNot Nothing Then
                    rndrVisualMap?.DrawModel(RenderMode.Fill)
                End If
...
#Region "Objects"
        ...
        Private Sub SetObjectsToPropertyGrid(objs As Object())
        ...
        Private Sub ButtonItem_ObjectsEditorCmd_Click(sender As Object, e As EventArgs) Handles ButtonItem_ObjectsEditorCmd.Click
...
#Region "Model-ID & Behavior-ID"
        ...
        Private Sub ChangeObjectComboWithDialog()
            Dim objs As Managed3DObject() = SelectedObjects
        ...
        Private Sub ChangeBehaviorWithDialog()
            Dim objs As Managed3DObject() = SelectedObjects
        ...
        Private Sub ButtonItem_ChangeObjectCombo_Click(sender As Object, e As EventArgs) Handles ButtonItem_ChangeObjectCombo.Click, ButtonItem31.Click
            ChangeObjectComboWithDialog()
        End Sub

        Private Sub ButtonItem30_Click(sender As Object, e As EventArgs) Handles ButtonItem30.Click, ButtonItem32.Click
            ChangeBehaviorWithDialog()
        End Sub

        Private Sub RibbonBar27_DialogLauncherMouseDown(sender As Object, e As MouseEventArgs) Handles RibbonBar27.DialogLauncherMouseDown
...
#Region "Warps"
        ...
        Private Sub ButtonX_WarpsEditCmd_Click(sender As Object, e As EventArgs) Handles ButtonX_WarpsEditCmd.Click
...
#Region "AdvPropertyGrid1"
        ...
        'Private Sub ProvideBParamContentList(sender As ContentSelectorEditor.ComboBoxEditor, e As EventArgs)
        '    Dim obj As Managed3DObject = SelectedObject
        '    Dim i As Byte
