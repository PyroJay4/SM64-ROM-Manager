...
Friend Class AdvPropGrid_ObjectPropertiesHelper
    ...
    Public Sub LoadComboBoxObjComboEntries(objComboList As ObjectComboList)
        ...
        For Each c As ObjectComboList.ObjectCombo In objComboList
        ...
        Select Case e.PropertyDescriptor.Name.ToString
            Case bParamPropName & 1
                If CbEditorBParam1 IsNot e.Editor Then
                    ...
                    CbEditorBParam1.DisplayMember = NameOf(BehaviorInfoList.BParamValue.ValueText)
                    CbEditorBParam1.ValueMember = NameOf(BehaviorInfoList.BParamValue.Value)
                    CbEditorBParam1.DropDownColumns = NameOf(BehaviorInfoList.BParamValue.ValueText) & "," & NameOf(BehaviorInfoList.BParamValue.Name)
            ...
            Case bParamPropName & 2
                If CbEditorBParam2 IsNot e.Editor Then
                    ...
                    CbEditorBParam2.DisplayMember = NameOf(BehaviorInfoList.BParamValue.ValueText)
                    CbEditorBParam2.ValueMember = NameOf(BehaviorInfoList.BParamValue.Value)
                    CbEditorBParam2.DropDownColumns = NameOf(BehaviorInfoList.BParamValue.ValueText) & "," & NameOf(BehaviorInfoList.BParamValue.Name)
            ...
            Case behaviorPropName
                If CbEditorBehavAddr IsNot e.Editor Then
                    ...
                    CbEditorBehavAddr.DisplayMember = NameOf(BehaviorInfoList.BehaviorInfo.BehaviorAddressText)
                    CbEditorBehavAddr.ValueMember = NameOf(BehaviorInfoList.BehaviorInfo.BehaviorAddress)
                    CbEditorBehavAddr.DropDownColumns = NameOf(BehaviorInfoList.BehaviorInfo.BehaviorAddressText) & "," & NameOf(BehaviorInfoList.BehaviorInfo.Name)
    ...
    Private Sub ProvideBParamContentList(sender As ContentSelectorEditor.ComboBoxEditor, e As EventArgs) Handles CbEditorBParam1.NeedValues, CbEditorBParam2.NeedValues
        ...
        If sender.Tag <> addr Then
            ...
            If Not String.IsNullOrEmpty(bpname) Then
                Dim info As BehaviorInfoList.BehaviorInfo = BehaviorInfos.GetByBehaviorAddress(addr)
                If info IsNot Nothing Then
                    Dim param As BehaviorInfoList.BParam = info.GetValue(bpname)
