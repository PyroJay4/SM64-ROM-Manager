...
Partial Class CustomBankManager
    ...
    Private Sub InitializeComponent()
        ...
        Me.CheckBoxX1.Text = "Enable Model ID"
        '
        'TextBoxX1
        '
        ...
        Me.ButtonX4.Text = "Import Collision"
        '
        'CheckBoxX2
        '
        '
        ...
        Me.CheckBoxX2.TabIndex = 8
        Me.CheckBoxX2.Text = "Enable Model"
        '
        'CheckBoxX3
        '
        '
        ...
        Me.CheckBoxX3.TabIndex = 9
        Me.CheckBoxX3.Text = "Enable Collision"
        '
        'CheckBoxX4
        '
        '
        ...
        Me.CheckBoxX4.TabIndex = 10
        Me.CheckBoxX4.Text = "Extra space"
        '
        'TextBoxX2
        '
