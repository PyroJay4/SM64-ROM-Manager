...
Public Class MainController
    ...
    Public Const UPDATE_URL As String = "https://pilzinsel64.com/Updates/SM64_ROM_Manager.json" '"http://pilzinsel64.square7.ch/Updates/SM64_ROM_Manager_New/updates.json"
