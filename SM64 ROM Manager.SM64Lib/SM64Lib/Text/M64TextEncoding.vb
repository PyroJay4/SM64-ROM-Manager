...
Namespace Text
    ...
    Public Class M64TextEncoding
        Inherits System.Text.Encoding

        Public Shared ReadOnly Property M64Text As System.Text.Encoding
            Get
                Static enc As New M64TextEncoding
                Return enc
            End Get
        End Property
        ...
        Public Overrides Function GetByteCount(chars() As Char, index As Integer, count As Integer) As Integer
            Dim myChars As Char() = chars.Skip(index).Take(count)
            Dim nbytes As Byte() = GetBytes(New String(myChars))

            Return nbytes.Length
        End Function

        Public Overrides Function GetBytes(chars() As Char, charIndex As Integer, charCount As Integer, bytes() As Byte, byteIndex As Integer) As Integer
            Dim myChars As Char() = chars.Skip(charIndex).Take(charCount)
            Dim nbytes As Byte() = GetBytes(New String(myChars))
            Dim bytesToCopy As Integer = Math.Min(nbytes.Length, bytes.Length - byteIndex)
        ...
        Public Overrides Function GetCharCount(bytes() As Byte, index As Integer, count As Integer) As Integer
            Dim myBytes As Byte() = bytes.Skip(index).Take(count)
            Dim nstring As String = GetString(bytes)

            Return nstring.Length
        End Function

        Public Overrides Function GetChars(bytes() As Byte, byteIndex As Integer, byteCount As Integer, chars() As Char, charIndex As Integer) As Integer
            Dim myBytes As Byte() = bytes.Skip(byteIndex).Take(byteCount)
            Dim nstring As String = GetString(bytes)
            Dim charsToCopy As Integer = Math.Min(nstring.Length, chars.Length - charIndex)

            For i As Integer = 0 To charsToCopy
